          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="space-y-1 text-sm">
                ...
                <DetailRow label="Capital" value={country.capital?.join(', ') || 'N/A'} />
                <DetailRow label="Population" value={formattedPopulation || 'N/A'} />
                    ...
                    bordersLoading ? (
                      <div className="flex gap-2">
                        {Array.from({ length: 3 }).map((_, idx) => (
                          <div key={idx} className="h-8 w-20 rounded bg-muted animate-pulse" />
                        ))}
                      </div>
                    ) : (borderCountries?.length ?? 0) > 0 ? (
                      <div data-testid="border-countries" className="flex flex-wrap gap-2">
